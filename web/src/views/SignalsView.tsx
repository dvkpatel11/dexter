...
export function SignalsView() {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      <PreviewBanner
        title="Signals"
        description="Research-driven trade signals generated by Dexter's analysis skills. Signals populate automatically as you run analyses in Chat."
        requirement="Use Chat to run DCF, comps, or technical analysis — signals will appear here."
      />
      <div className="mb-6">
